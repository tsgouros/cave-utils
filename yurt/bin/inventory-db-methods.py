...
class InventoryDatabaseManager:
    ...
    def addPosition(self,index,location,serialSwitch,serialPort,server,display):
        '''
        ...
        '''
        self._db.insertIntoPositions(index,location,serialSwitch,serialPort,server,display)
